      ...
      <div className="container px-4 md:px-6">
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
          <div className="space-y-6">
            <h2 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl text-primary">About Me</h2>
            <p className="text-lg md:text-xl text-foreground/80 leading-relaxed">
              With over <span className="font-semibold text-primary">6 years of experience</span> building responsive, accessible, and user-centric web applications. My journey spans across custom web development, Drupal site building and theming, and decoupled architectures using <span className="font-medium text-foreground">Next.js</span>.
            </p>
            <p className="text-lg md:text-xl text-foreground/80 leading-relaxed">
